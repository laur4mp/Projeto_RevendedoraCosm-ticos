...
function deletarProduto(listali, produto) {
 ...
 function editarProduto(listali, produto) {
    ...
    let divBotoesEditar = document.createElement('div')
    divBotoesEditar.appendChild(editarBtn)
    divBotoesEditar.classList.add('opcoesDivEditar')
    let cancelarBtn = document.createElement('button');
    cancelarBtn.textContent = 'Cancelar';
    cancelarBtn.classList.add('opcoesEditar');
    divBotoesEditar.appendChild(cancelarBtn)
    listali.appendChild(divBotoesEditar);
